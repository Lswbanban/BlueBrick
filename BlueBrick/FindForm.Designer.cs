namespace BlueBrick
{
	partial class FindForm
	{
		...
		private void InitializeComponent()
		{
			...
			// FindPictureBox
			// 
			this.FindPictureBox.AccessibleDescription = null;
			this.FindPictureBox.AccessibleName = null;
			resources.ApplyResources(this.FindPictureBox, "FindPictureBox");
			this.FindPictureBox.BackgroundImage = null;
			this.FindPictureBox.Font = null;
			this.FindPictureBox.ImageLocation = null;
			this.FindPictureBox.Name = "FindPictureBox";
			this.FindPictureBox.TabStop = false;
			// 
			// ReplacePictureBox
			// 
			this.ReplacePictureBox.AccessibleDescription = null;
			this.ReplacePictureBox.AccessibleName = null;
			resources.ApplyResources(this.ReplacePictureBox, "ReplacePictureBox");
			this.ReplacePictureBox.BackgroundImage = null;
			this.ReplacePictureBox.Font = null;
			this.ReplacePictureBox.ImageLocation = null;
			this.ReplacePictureBox.Name = "ReplacePictureBox";
			this.ReplacePictureBox.TabStop = false;
			// 
			// ReplaceComboBox
			// 
			this.ReplaceComboBox.AccessibleDescription = null;
			this.ReplaceComboBox.AccessibleName = null;
			...
			// FindComboBox
			// 
			this.FindComboBox.AccessibleDescription = null;
			this.FindComboBox.AccessibleName = null;
			...
			// allLayerCheckBox
			// 
			this.allLayerCheckBox.AccessibleDescription = null;
			this.allLayerCheckBox.AccessibleName = null;
			resources.ApplyResources(this.allLayerCheckBox, "allLayerCheckBox");
			this.allLayerCheckBox.BackgroundImage = null;
			this.allLayerCheckBox.Font = null;
			...
			// LayerCheckedListBox
			// 
			this.LayerCheckedListBox.AccessibleDescription = null;
			this.LayerCheckedListBox.AccessibleName = null;
			resources.ApplyResources(this.LayerCheckedListBox, "LayerCheckedListBox");
			this.LayerCheckedListBox.BackgroundImage = null;
			this.LayerCheckedListBox.CheckOnClick = true;
			this.LayerCheckedListBox.Font = null;
			...
			// inLayerRadioButton
			// 
			this.inLayerRadioButton.AccessibleDescription = null;
			this.inLayerRadioButton.AccessibleName = null;
			resources.ApplyResources(this.inLayerRadioButton, "inLayerRadioButton");
			this.inLayerRadioButton.BackgroundImage = null;
			this.inLayerRadioButton.Font = null;
			...
			// 
			this.inCurrentSelectionRadioButton.AccessibleDescription = null;
			this.inCurrentSelectionRadioButton.AccessibleName = null;
			resources.ApplyResources(this.inCurrentSelectionRadioButton, "inCurrentSelectionRadioButton");
			this.inCurrentSelectionRadioButton.BackgroundImage = null;
			this.inCurrentSelectionRadioButton.Font = null;
