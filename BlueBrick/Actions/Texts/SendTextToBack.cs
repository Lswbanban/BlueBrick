...
namespace BlueBrick.Actions.Texts
{
	class SendTextToBack : Action
	{
		...
		public SendTextToBack(LayerText layer, List<Layer.LayerItem> textsToMove)
		{
			// init the layer
			mTextLayer = layer;
		...
		{
			return BlueBrick.Properties.Resources.ActionSendTextToBack;
		}
		...
		public override void redo()
		{
			...
			// add all the bricks at the begining
			foreach (Layer.LayerItem obj in mTexts)
				mTextLayer.addTextCell(obj as LayerText.TextCell, 0);
